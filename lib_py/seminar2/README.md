...
получиться величина _ centered_spa. Затем поделите a_centered_sp на N-1, где N - число
наблюдений.
...
Решение в файле [seminar2_numpy.ipynb](seminar2_numpy.ipynb)
...
Решение в файле [seminar2_pandas.ipynb](seminar2_pandas.ipynb)
